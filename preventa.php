                    ...
                    <div class="ibox ">
                        ...
                        ?>
                                <div class="ibox-content">
                                    ...
                                    <div class="row focuss"><br>
                                        ...
                                        <div class="col-md-6"><br>
                                            ...
                                            <button type="button" id="preventa" style="margin-left:3%;" name="preventa" class="btn btn-sm btn-success pull-right usage"><i class="fa fa-save"></i> F8
                                                Guardar</button>
                                            <button type="button" id="borrar_preven" style="margin-left:3%;" name="borrar_preven" class="btn btn-success btn-sm pull-right usage"><i class="fa fa-trash"></i> F6
                                                Borrar </button>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="modal-container">
                                    ...
                                    <div class="modal fade" id="viewProd" tabindex="-2" role="dialog" aria-labelledby="myModalCliente" aria-hidden="true">
                                        <div class="modal-dialog model-sm">
                                            <div class="modal-content"> </div>
                                        </div>
                                    </div>
