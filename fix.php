...
$datos = _query("SELECT * FROM `factura` WHERE factura.tipo_documento IN ('TIK','DEV') AND factura.finalizada=1 AND fecha between '2021-11-15' AND '2021-11-15' ORDER BY factura.id_factura ASC");
  $corelativo = 1;
