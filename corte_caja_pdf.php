...
//////////////Devoluciones
$devolucion = 0;
$sql_dev = _query("SELECT factura.numero_doc,factura.total,f.tipo_documento,f.numero_doc as doc FROM factura JOIN factura AS f ON f.id_factura=factura.afecta WHERE factura.tipo_documento IN ('DEV','NC') AND factura.id_apertura = $id_apertura");
...
if($cuenta_pagos > 0)
{
  ...
  $pdf->Cell(150,5,utf8_decode("TOTAL CARGOS PAGO TARJETA"),0,0,'L',0);
  $pdf->Cell(50,5,number_format($total_pagos, 2, '.', ','),0,1,'R',0);
